...
const Flame = createSvgIcon(
  ...
  >
    <path
      ...
      fill="url(#svg-fill-linear__light__gradient--backgroundBrandGradient)"
      fillRule="nonzero"
    ></path>
    <linearGradient
      id="svg-fill-linear__light__gradient--backgroundBrandGradient"
      ...
      spreadMethod="pad"
    >
      <stop offset="0%" stop-color="#fd267a"></stop>
      <stop offset="100%" stop-color="#ff6036"></stop>
    </linearGradient>
  </svg>,
  "Flame"
);
